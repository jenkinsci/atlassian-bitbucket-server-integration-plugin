...
public interface BitbucketMirrorSearchClient extends BitbucketClient<BitbucketPage<BitbucketRepository>> {

    /**
     * Search for Bitbucket Server mirrors whose names match the provided value. Matching is
     ...
     */
    BitbucketPage<BitbucketRepository> get(int repositoryId);
}
